...
<div id="ac" style="width:500px">
    ...
    <span><button type="submit" formMethod="post" formAction="entries_reported_save.php" class="btn btn-warning btn-block btn-large" style="float:right; width:230px; height:35px;"><i class="icon icon-bell icon-large"></i> Report</button></span>
    </div>
</div>
</form>