...
class HTMLPurifier_HTMLModule_Tidy_XHTMLAndHTML4 extends HTMLPurifier_HTMLModule_Tidy
{
    ...
    public function makeFixes()
    {
        ...
        $r['ul* @var'] = new HTMLPurifier_AttrTransform_EnumToCSS('type', $ul_types);
        $r['ol* @var'] = new HTMLPurifier_AttrTransform_EnumToCSS('type', $ol_types, true);
        $r['li* @var'] = new HTMLPurifier_AttrTransform_EnumToCSS('type', $li_types, true);
